...
test('Loading Home Page', () => {
  const location = { search: "?searchString=Algorithms&signedIn=n" }
  const wrapper = shallow(<CHSearch location={location} />);
  wrapper.setState({ choice: "home", firstName: "", email: "", queryString: "" });
  expect(wrapper.exists()).toBe(true);
});

test('Login Screen', () => {
  const location = { search: "?searchString=Algorithms&firstName=Test1&&email=test1@test.com&&signedIn=y" }
  const wrapper = shallow(<CHSearch location={location} />);
  wrapper.setState({ choice: "loginScreen", firstName: "", email: "", queryString: "" });
  expect(wrapper.exists()).toBe(true);
});
...
test('Signup Screen', () => {
  ...
  const wrapper = shallow(<CHSearch location={location} />);
  wrapper.setState({ choice: "signupScreen", firstName: "", email: "", queryString: "" });
  expect(wrapper.exists()).toBe(true);
});
...
test('Forgot Password Screen', () => {
  const location = { search: { searchString: "testString", firstName: "Test1", email: "test1@test.com" } }
  const wrapper = shallow(<CHSearch location={location} />);
  wrapper.setState({ choice: "forgotPasswordScreen", firstName: "", email: "", queryString: "" });
  expect(wrapper.exists()).toBe(true);
});
...
test('Home Screen after signing in', () => {
  const location = { search: { searchString: "testString", firstName: "Test1", email: "test1@test.com" } }
  const wrapper = shallow(<CHSearch location={location} />);
  wrapper.setState({ choice: "homeSignedIn", firstName: "Test1", email: "test1@test.com", queryString: "" });
  expect(wrapper.exists()).toBe(true);
});
